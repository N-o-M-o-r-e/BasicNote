...
class NotallyApplication : Application(), Application.ActivityLifecycleCallbacks {
    ...
    override fun onCreate() {
        ...
        val request =
            PeriodicWorkRequest.Builder(AutoBackupWorker::class.java, 6, TimeUnit.HOURS).build()
